...
class AutoEncoder(nn.Module):
    ...
    def forward(self, inputs):
        ...
        #####################################################################
        temp1 = self.g(inputs)
        hidden_layer = temp1.sigmoid()
        temp2 = self.h(hidden_layer)
        out = temp2.sigmoid()
        #####################################################################
        #                       END OF YOUR CODE                            #
        #####################################################################
...
def main():
    ...
    zero_train_matrix = np.load("../data/imputed_matrix.npz")["arr_0"]
    zero_train_matrix = torch.FloatTensor(zero_train_matrix)
    ...
    for k in k_lst:
        ...
        train_loss_temp, valid_accuracy_temp = train(model, lr, 0, zero_train_matrix, zero_train_matrix,
